#FamousLoadings
> Some loadings using famo.us.

[![Build Status](https://travis-ci.org/fabiowitt/famousloadings.svg?branch=master)](https://travis-ci.org/fabiowitt/famousloadings) [![Dependency Status](https://david-dm.org/fabiowitt/famousloadings.svg)](https://david-dm.org/fabiowitt/famousloadings) [![devDependency Status](https://david-dm.org/fabiowitt/famousloadings/dev-status.svg)](https://david-dm.org/fabiowitt/famousloadings#info=devDependencies)
...
## Release History
 * 2014-10-20   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)